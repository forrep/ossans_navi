...
SLACK_SIGNING_SECRET = os.environ["OSN_SLACK_SIGNING_SECRET"]
...
MODEL_FOR_VIDEO_AUDIO_DESCRIPTION = "LOW_COST"
MODEL_FOR_SLACK_SEARCH_WORDS = "HIGH_QUALITY"
MODEL_FOR_REFINE_SLACK_SEARCHES = "LOW_COST"
